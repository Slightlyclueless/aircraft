...
import { MfdFmsDataRoute } from 'instruments/src/MFD/pages/FMS/DATA/MfdFmsDataRoute';
...
export function pageForUrl(
  ...
  switch (url) {
    ...
    case 'fms/data/route':
      return <MfdFmsDataRoute pageTitle="ROUTE" bus={bus} mfd={mfd} fmcService={fmcService} />;
